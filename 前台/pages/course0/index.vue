<template>
  <div>
    <div>
      ...
      <img class="" src="https://codeman666.oss-cn-beijing.aliyuncs.com/online-learning/front/0.jpg" height="350" width="1535" />
    </div>
...
export default {
  ...
  methods: {
    // 查询第一页数据
    initCourseFirst() {
      courseApi.getCourseList(1, 8, 0, this.searchObj).then(response => {
    ...
    gotoPage(current) {
      ...
      courseApi.getCourseList(current, 8, 0, this.searchObj).then(response => {
        this.data = response.data.data
      })
    },
