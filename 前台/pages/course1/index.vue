<template>
  <div>
    <div>
      ...
      <img class="" src="https://codeman666.oss-cn-beijing.aliyuncs.com/online-learning/front/1.jpg" height="350" width="1535" />
    </div>
                ...
                <li v-for="course in data.items" :key="course.id">
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      ...
                      <div class="cc-mask">
                        <a :href="'/course1/'+course.id" title="开始学习" class="comm-btn c-btn-1">开始学习</a>
                      </div>
                    </section>
...
export default {
  ...
  methods: {
    // 查询第一页数据
    initCourseFirst() {
      courseApi.getCourseList(1, 8, 1, this.searchObj).then(response => {
    ...
    gotoPage(current) {
      ...
      courseApi.getCourseList(current, 8, 1, this.searchObj).then(response => {
        this.data = response.data.data
      })
    },
